...
if RERANKER == "GPT":
    ...
    gpt2Tokenizer = OpenAIGPTTokenizer.from_pretrained('openai-gpt', cache_dir=Path('.'))
    gpt2LMHeadModel = OpenAIGPTLMHeadModel.from_pretrained('openai-gpt', cache_dir=Path('.'))
